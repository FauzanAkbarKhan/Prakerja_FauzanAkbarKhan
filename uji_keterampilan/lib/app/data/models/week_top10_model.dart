class WeekTop10 {
  ...
  WeekTop10({this.status, this.message, this.timestamp, this.data});

  WeekTop10.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    titleRuntime = json['titleRuntime'] != null
        ...
        : null;
    chartMeterRanking = json['chartMeterRanking'] != null
        ? ChartMeterRanking?.fromJson(json['chartMeterRanking'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (chartMeterRanking != null) {
      data['chartMeterRanking'] = chartMeterRanking?.toJson();
    }
    return data;
  }
}
...
class TitleRuntime {
  int? seconds;
  TitleRuntimeDisplayableProperty? displayableProperty;
  ...
  TitleRuntime.fromJson(Map<String, dynamic> json) {
    ...
    displayableProperty = json['displayableProperty'] != null
        ? TitleRuntimeDisplayableProperty?.fromJson(json['displayableProperty'])
        : null;
  }
...
class ChartMeterRanking {
  int? currentRank;
  RankChange? rankChange;

  ChartMeterRanking({this.currentRank, this.rankChange});

  ChartMeterRanking.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (rankChange != null) {
      data['rankChange'] = rankChange?.toJson();
    }
    return data;
  }
}
...
class RankChange {
  ...
  RankChange({this.changeDirection, this.difference});
